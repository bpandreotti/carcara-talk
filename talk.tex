...
\begin{frame}[fragile]
  \frametitle{Example}
\begin{minted}[fontsize=\footnotesize, frame=single]{smtlib2.py -x}
(set-logic LIA)
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \vspace{4ex}
    \vitem Carcara makes uses \textit{hash consing} when parsing terms
    \vspace{4ex}
...
\begin{frame}[fragile]
  ...
  \begin{minipage}{0.45 \textwidth}
    \begin{minted}[fontsize=\footnotesize, frame=single, escapeinside=||]{smtlib2.py -x}
(set-logic QF_UF)
